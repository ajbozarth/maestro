...
def deploy_meta_agents_streamlit(prompt_text_file):
    ...
    # Page header
    st.image(
        "https://raw.githubusercontent.com/AI4quantum/maestro/main/images/maestro.png",
        width=200,
    )
    ...
    with agents_tab:
        ...
        ma_agents_workflow_ui = StreamlitWorkflowUI(
            "src/agents/meta_agent/agents.yaml",
            "src/agents/meta_agent/workflow_agent.yaml",
            prompt,
    ...
    with workflow_tab:
        ...
        ma_workflow_workflow_ui = StreamlitWorkflowUI(
            "src/agents/meta_agent/agents.yaml",
            "src/agents/meta_agent/workflow_workflow.yaml",
            prompt,
